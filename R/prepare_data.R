...
#'
#' @description Performs 4 separate steps to prepare a DIA-NN output for data analysis. 1 Data is imported as implemented in the diann package. 2 Precursors are filtered. 3 According to protein groups, abundances are calculated using the MaxLFQ algorithm as implemented in the diann package. 4 Data is tidied.
#'
